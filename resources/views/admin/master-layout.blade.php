...
<html>
    <head>
        <meta charset="utf-8" />
        <title>ETL English - Trang quản trị</title>
        <base href="{{asset('')}}">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="javascript:void(0)"><span class="badge badge-success pull-right">5</span>Cài đặt</a></li>
                                        <li><a href="javascript:void(0)">Khóa màn hình</a></li>
                                        <li class="divider"></li>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="ti-dropbox-alt"></i> <span> UI Elements </span> <span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
