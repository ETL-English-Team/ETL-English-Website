            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="panel panel-primary text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="text-muted"><b>23</b> ngày từ ngày mở đăng ký</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="panel panel-primary text-center">
                        ...
                        <div class="panel-body">
                            <h3 class=""><b>23</b></h3>
                            <p class="text-muted"><b>23</b> tài khoản đang online</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="panel panel-primary text-center">
                        ...
                        <div class="panel-body">
                            <h3 class=""><b>2234</b></h3>
                            <p class="text-muted"><b>2234</b> từ thuộc <b>25</b> chủ đề</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="panel panel-primary text-center">
                        ...
                        <div class="panel-body">
                            <h3 class=""><b>8</b></h3>
                            <p class="text-muted"><b>8</b> lượt góp ý tuần này</p>
                        </div>
                    </div>
                </div>
            </div>
