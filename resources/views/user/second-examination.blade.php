            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Phần 2 - Điền từ nghe được</h4>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 examination-question">
                    <div class="panel panel-primary text-center vocabulary-box">
                        ...
                        <div class="panel-body">
                            <img onclick="playAudio()" src="assets/images/icon-sound.png" class="question-img" style="cursor:pointer" alt="">
