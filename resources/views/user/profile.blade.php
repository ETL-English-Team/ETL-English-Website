                ...
                <div class="col-xs-12 hidden-sm hidden-md hidden-lg">
                    <div class="panel panel-primary text-center vocabulary-box">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-12">
                                <img src="assets/images/MagicSoundBox.jpg" class="profile-img" alt="">
                            </div>
                            <div class="col-xs-12  profile-info-mobile">
                                <div class="row">
                                    <div class="col-xs-6 profile-info-label"><b>username:</b></div>
                                    <div class="col-xs-6 profile-info-content">nguyenhoangphuc</div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6 profile-info-label"><b>Họ và tên:</b></div>
                                    <div class="col-xs-6 profile-info-content">Nguyễn Hoàng Phúc</div>
                                </div> 
                                <div class="row">
                                    <div class="col-xs-6 profile-info-label"><b>Ngày sinh:</b></div>
                                    <div class="col-xs-6 profile-info-content">04-04-1998</div>
                                </div>     
                                <div class="row">
                                    <div class="col-xs-6 profile-info-label"><b>Ngày tạo tài khoản:</b></div>
                                    <div class="col-xs-6 profile-info-content">23/12/2019</div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6 profile-info-label"><b>Level hiện tại:</b></div>
                                    <div class="col-xs-6 profile-info-content">Level 12</div>
                                </div>  
                                <div class="row">
                                    <div class="col-xs-6 profile-info-label"><b>Công việc hiện tại:</b></div>
                                    <div class="col-xs-6 profile-info-content">Sinh viên</div>
                                </div>      
                                <div class="row">
                                    <div class="col-xs-6 profile-info-label"><b>Đang làm việc tại:</b></div>
                                    <div class="col-xs-6 profile-info-content">Trường Đại học Kỹ thuật Công nghệ - Cần Thơ</div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="profile-info">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 profile-info-content">nguyenhoangphuc</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4 profile-info-label"><b>Họ và tên:</b></div>
                                            <div class="col-sm-8 profile-info-content">Nguyễn Hoàng Phúc</div>
                                        </div> 
                                        <div class="row">
                                            <div class="col-sm-4 profile-info-label"><b>Ngày sinh:</b></div>
                                            <div class="col-sm-8 profile-info-content">04-04-1998</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4 profile-info-label"><b>Email:</b></div>
                                            <div class="col-sm-8 profile-info-content">blablahotga@gmail.com</div>
                                        </div>     
                                        <div class="row">
                                            <div class="col-sm-4 profile-info-label"><b>Ngày tạo tài khoản:</b></div>
                                            <div class="col-sm-8 profile-info-content">23/12/2019</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4 profile-info-label"><b>Level hiện tại:</b></div>
                                            <div class="col-sm-8 profile-info-content">Level 12</div>
                                        </div>  
                                        <div class="row">
                                            <div class="col-sm-4 profile-info-label"><b>Công việc hiện tại:</b></div>
                                            <div class="col-sm-8 profile-info-content">Sinh viên</div>
                                        </div>      
                                        <div class="row">
                                            <div class="col-sm-4 profile-info-label"><b>Đang làm việc tại:</b></div>
                                            <div class="col-sm-8 profile-info-content">Trường Đại học Kỹ thuật Công nghệ - Cần Thơ</div>
                                        </div>                
                                    </div>
                                </div>
                            </div>
